...
import { theme, Input as Input$1, Dropdown as Dropdown$1, Image, Button as Button$1, Card as Card$1, Modal, Divider as Divider$1, Drawer as Drawer$1, Layout as Layout$1, Menu, Progress as Progress$1, Rate as Rate$1, Segmented as Segmented$1, Slider as Slider$1, Tag as Tag$1 } from 'antd';
...
var AdvancedTableColumn = function AdvancedTableColumn(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Panel, {
    ...
    style: titleStyle
  }, title)), cells)), React.createElement(PanelResizeHandle, null));
};
...
var Avatar = function Avatar(_ref) {
  ...
  }, type === "image" && React.createElement(Image, {
    src: content,
    width: "100%",
    height: "100%",
    preview: false,
  ...
  }), type === "text" && React.createElement("p", {
    style: {
...
var Card = function Card(_ref) {
  ...
  return React.createElement(Card$1, Object.assign({
    bordered: true,
    loading: isLoading,
...
var Dropdown = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  return React.createElement(Dropdown$1, {
    ...
    dropdownRender: function dropdownRender() {
      ...
      }, searchable && React.createElement(React.Fragment, null, React.createElement(Input, {
        size: "small",
        debounce: 500,
        variant: "borderless",
        placeholder: "Buscar...",
      ...
      }, searchValue ? "¡Vaya! Parece que no hay resultados para tu búsqueda" : "¡Vaya! Parece que actualmente no hay registros para mostrar")) : React.createElement("div", {
        style: {
          overflow: "auto",
          maxHeight: maxHeight
        }
...
var DropdownItem = function DropdownItem(_ref) {
  ...
  }, isSelected && selectedPosition === "left" && React.createElement(Icon, {
    size: 16,
    variant: "duotone",
    icon: "CheckCircle",
    color: token.colorPrimary
  }), leftSection, React.createElement("p", {
    className: "dropdown-item-label",
    style: labelStyle
  }, label), rightSection, isSelected && selectedPosition === "right" && React.createElement(Icon, {
    size: 16,
    variant: "duotone",
    icon: "CheckCircle",
    color: token.colorPrimary
...
var FormField = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return React.createElement("div", {
    ...
    htmlFor: name,
    style: labelStyles
  }, label)), React.cloneElement(content, {
    error: error,
    onClearError: handleClearError
  }), error && React.createElement("div", {
    className: "error-container",
    style: errorContainerStyles
  }, React.createElement(WarningDiamond, {
    size: 12,
    weight: "bold"
  }), React.createElement("p", {
...
var Layout = function Layout(_ref) {
  ...
  return React.createElement(Layout$1, {
  ...
  }, React.createElement(Layout$1.Sider, {
    collapsible: true,
    width: 275,
    theme: "light",
    trigger: null,
  ...
  }, showTrigger && React.createElement(Button, {
    label: "",
    size: "small",
    type: "default",
    isSubmit: false,
    ...
    icon: collapsed ? React.createElement(CaretRight, {
      size: 14
    }) : React.createElement(CaretLeft, {
      size: 14
    })
  }), menuTopSection && React.createElement("div", {
    style: {
      padding: "8px"
    }
  }, menuTopSection), React.createElement(Menu, {
    theme: "light",
    mode: "inline",
  ...
  }), menuBottomSection && React.createElement("div", {
    style: {
      padding: "10px",
  ...
  }, menuBottomSection)), React.createElement(Layout$1, {
    style: {
  ...
  }, showHeader && React.createElement(Layout$1.Header, {
    style: headerStyles
  }, React.createElement("div", {
    style: {
      minWidth: "100%",
  ...
  }, headerContent)), React.createElement(Layout$1.Content, {
    style: {
...
var PasswordInput = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return React.createElement(Input$1.Password, Object.assign({
    ref: ref,
    prefix: leftIcon,
    suffix: rightIcon,
...
var Rate = function Rate(_ref) {
  ...
  return React.createElement(Rate$1, Object.assign({
    value: value,
...
var Segmented = function Segmented(_ref) {
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(options), _step; !(_step = _iterator()).done;) {
    ...
    parsedOptions.push({
      label: option.label,
      value: option.value,
      icon: option.icon ? React.createElement(Icon, {
        icon: option.icon,
        size: 16,
        variant: "regular"
      }) : undefined,
  ...
  return React.createElement(Segmented$1, Object.assign({
...
var Select = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return React.createElement(Dropdown, {
    ...
    triggerContent: React.createElement("div", {
    ...
    }, (internalValue == null ? void 0 : internalValue.label) && valueContent, React.createElement("span", {
      style: labelStyles
    }, (_internalValue$label = internalValue == null ? void 0 : internalValue.label) != null ? _internalValue$label : placeholder), React.createElement(Icon, {
      icon: "CaretUpDown",
      size: 16,
      variant: "regular",
      color: token.colorTextSecondary
...
var Slider = function Slider(_ref) {
  var props = _extends({}, (_objectDestructuringEmpty(_ref), _ref));
  return React.createElement(Slider$1, Object.assign({}, props));
};
var sliderMeta = {
  name: "Slider",
  displayName: "Slider",
...
var Stat = function Stat(_ref) {
  ...
  return React.createElement("div", {
    ...
    style: titleStyles
  }, title), icon && icon)), React.createElement("div", {
    className: "value",
    style: valueStyle
  }, loading ? React.createElement(Skeleton, {
    count: 1,
    width: "25%",
    height: "32px"
  }) : React.createElement(React.Fragment, null, prefix && React.createElement("span", {
    className: "prefix",
    style: prefixStyle
    ...
    className: "suffix",
    style: suffixStyle
  }, suffix))), (comparison || comparison == 0) && React.createElement("div", {
    ...
    width: "80%",
    height: "18px"
  }) : React.createElement(React.Fragment, null, React.createElement(Tag, {
    style: {
      margin: 0,
      lineHeight: "16px",
      display: "flex",
    ...
    icon: comparison > 0 ? React.createElement(Icon, {
      ...
      size: 12,
      variant: "regular"
    }) : comparison < 0 ? React.createElement(Icon, {
      icon: "TrendDown",
      size: 12,
      variant: "regular"
    }) : React.createElement(Icon, {
  ...
  }), comparisonLabel && React.createElement("span", {
    style: {
      color: "#868E96",
      fontSize: "12px",
      fontWeight: 400,
...
export { registerAll };
//# sourceMappingURL=inprodi-design-system.esm.js.map
